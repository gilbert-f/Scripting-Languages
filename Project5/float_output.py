	...
	while (true) {
		switch (state) {
			...
			case S3_STATE:
				...
				default:
					cerr << "INVALID EVENT " << event <<  " in state S3 " << endl;
					return -1;
				}
				break;
			...
			case S2_STATE:
				...
				default:
					cerr << "INVALID EVENT " << event <<  " in state S2 " << endl;
					return -1;
				}
				break;
			...
			case S1_STATE:
				...
				default:
					cerr << "INVALID EVENT " << event <<  " in state S1 " << endl;
					return -1;
				}
				break;
			...
			case S0_STATE:
				...
				default:
					cerr << "INVALID EVENT " << event <<  " in state S0 " << endl;
					return -1;
				}
				break;
			...
			case S7_STATE:
				...
				default:
					cerr << "INVALID EVENT " << event <<  " in state S7 " << endl;
					return -1;
				}
				break;
			...
			case S6_STATE:
				...
				default:
					cerr << "INVALID EVENT " << event <<  " in state S6 " << endl;
					return -1;
				}
				break;
			...
			case S5_STATE:
				...
				default:
					cerr << "INVALID EVENT " << event <<  " in state S5 " << endl;
					return -1;
				}
				break;
			...
			case S4_STATE:
				...
				default:
					cerr << "INVALID EVENT " << event <<  " in state S4 " << endl;
					return -1;
				}
				break;
...
return 1;
				...
				default:
					cerr << "INVALID EVENT " << event <<  " in state ACCEPT " << endl;
					return -1;
				}
				break;
